package destiny.fearthelight.server.entities.goals;
...
public class CustomMeleeAttackGoal extends Goal {
    ...
    public double attackReachSqr;
    public int attackCooldown;

    public CustomMeleeAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen, double attackReachSqr, int attackCooldown) {
        this.mob = pMob;
    ...
    protected int getAttackInterval() {
        return this.adjustedTickDelay(attackCooldown);
    }
